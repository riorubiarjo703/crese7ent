      ...
      <div className="container">
        ...
        <ul className="text-muted-foreground grid grid-cols-2 items-center gap-7 md:grid-cols-3 lg:grid-cols-6">
          <li className="flex items-center gap-2 font-medium">
            <SocialIcon type="discord" className="size-6 shrink-0" />
            Discord
          </li>
          <li className="flex items-center gap-2 font-medium">
            <SocialIcon type="reddit" className="size-6 shrink-0" />
            Reddit
          </li>
          <li className="flex items-center gap-2 font-medium">
            <SocialIcon type="twitter" className="size-6 shrink-0" />
            Twitter
          </li>
          <li className="flex items-center gap-2 font-medium">
            <SocialIcon type="telegram" className="size-6 shrink-0" />
            Telegram
          </li>
          <li className="flex items-center gap-2 font-medium">
            <SocialIcon type="linkedin" className="size-6 shrink-0" />
            LinkedIn
          </li>
        </ul>
      </div>
