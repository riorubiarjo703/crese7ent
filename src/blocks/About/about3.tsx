...
const About3: React.FC<AboutBlock & { publicContext: PublicContextProps }> = ({
  ...
  return (
    <section className="bg-background text-foreground py-32" data-scroll-reveal="up">
        ...
        <div className="mb-14 grid gap-5 text-center md:grid-cols-2 md:text-left">
          {headline && (
            <RichText
              ...
              withWrapper={false}
              overrideStyle={{
                h1: 'text-5xl font-semibold text-neutral-950',
                h2: 'text-3xl font-semibold text-neutral-950',
                h3: 'text-2xl font-semibold text-neutral-950',
              ...
              <div>
                {text1 && (
                  <RichText
                    ...
                    withWrapper={false}
                    overrideStyle={{
                      h2: 'mb-2 text-2xl font-semibold text-neutral-950',
                      h3: 'mb-2 text-xl font-semibold text-neutral-950',
                      h4: 'mb-2 text-lg font-semibold text-neutral-950',
          ...
          <div className="flex flex-col gap-4 text-center md:text-left">
            {text2 && (
              <RichText
                ...
                withWrapper={false}
                overrideStyle={{
                  h2: 'text-4xl font-semibold text-neutral-950',
                  h3: 'text-2xl font-semibold text-neutral-950',
                  h4: 'text-xl font-semibold text-neutral-950',
            ...
            {Array.isArray(counter) &&
              counter.map((c) => (
                <div key={c.id} className="flex flex-col gap-4">
                  ...
                  <span className="text-4xl font-semibold text-neutral-950 md:text-5xl">
                    {c.value}
                  </span>
                </div>
              ))}
