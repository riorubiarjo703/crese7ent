...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  const animate = useCallback(() => {
    if (canvasContainerRef.current) {
      ...
      mouse.current.x = mousePositionRef.current.x - rect.left
      mouse.current.y = mousePositionRef.current.y - rect.top
    }
  ...
  }, [circleParams, clearContext, drawCircle, ease, mousePositionRef, remapValue, staticity, vx, vy])
