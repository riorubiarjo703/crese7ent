...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Our AI support team will get back to you in approximately 3-5 business years.',
  },
  // Account Questions
  {
    category: 'Account',
  ...
  // Features Questions
  {
    ...
    answer: "Probably! But until then, we'll keep pretending we're irreplaceable.",
  },
  {
    category: 'Features',
    question: 'What makes your platform unique?',
    answer: 'We use at least 7 different types of AI, and none of them work together!',
  },
  {
    category: 'Features',
  ...
  // Security Questions
  {
    ...
    answer: 'We use military-grade encryption, but our password is "password123".',
  },
  {
    category: 'Security',
    question: 'What happens in case of a data breach?',
    answer: "We'll send you a very apologetic email with a $5 gift card to your local coffee shop.",
  },
  {
    category: 'Security',
...
const Faq12 = ({ className }: Faq12Props) => {
  ...
  return (
    <section
      className={cn(
        'h-svh max-h-[1200px] min-h-[600px] bg-[#F2F2F2] py-32 dark:bg-[#24242B]',
        className,
      )}
    >
      <div className="container max-w-4xl">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mx-auto mt-4 max-w-xl text-center text-balance">
            This really should be an LLM but we're waiting for RAG to truly reach commodity stage
            before we touch it.
          </p>
        </div>
